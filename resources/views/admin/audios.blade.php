...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Audios and Brochures</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route("admin/") }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin/audios') }}">Book/brochures</a></li>
            ...
            <table class="table datatable">
              ...
              @endphp
                <tr>
                  ...
                  <td>
                    <form method="post" action="audios/{{ $book->id }}">
                      @csrf
                      @method('DELETE')
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title d-none d-lg-block">Add audios</h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
    
         <form method="post" action="{{route('admin/audios')}}" enctype="multipart/form-data">
            @csrf
